  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard title="Total Records" value="4,562" icon={FileText} trend="up" trendValue="+8.2%" color="green" />
        <StatCard title="Monthly Growth" value="18.5%" icon={TrendingUp} trend="up" trendValue="+2.4%" color="purple" />
        <StatCard title="Active Cases" value="342" icon={Activity} trend="down" trendValue="-3.1%" color="orange" />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <GlassCard className="p-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Monthly Patient Trends</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <GlassCard className="p-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Weekly Activity Overview</h3>
          <ResponsiveContainer width="100%" height={300}>
        ...
        <GlassCard className="p-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Patient Age Distribution</h3>
          <ResponsiveContainer width="100%" height={300}>
